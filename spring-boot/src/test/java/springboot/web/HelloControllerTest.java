...
public class HelloControllerTest {
    ...
    public void helloDto가_리턴된다() throws Exception{
        ...
        mvc.perform(get("/hello/dto").param("name","kkc").param("amount",String.valueOf(100))).andExpect(status().isOk()).andExpect(jsonPath("$.name",is("kkc"))).andExpect(jsonPath("$.amount",is(100)));
